 ...
 * 04-simplified.png            - Simplified beginner chord mode with hero chord & hand voicings (1440x900)
 * 05-original.png              - Original rich harmonic chord mode (1440x900)
 * 06-current-chord.png         - Live playback with hero current chord & real-time progress bar (1440x900)
 * 07-chord-transition.png      - Coordinated physical slide transition between chords (1440x900)
 * 08-hands-piano.png           - Highlighting synchronized Left/Right hands and 61-key piano (1440x900)
 * 09-mobile.png                - Responsive mobile workspace layout (390x844)
 */
...
async function captureReleaseScreenshots() {
    ...
    await page.screenshot({ path: path.join(DOCS_SCREENSHOT_DIR, '04-simplified.png') });
    console.log('  ✓ Captured 04-simplified.png (1440x900)');
    ...
    await new Promise(r => setTimeout(r, 300));
    await page.screenshot({ path: path.join(DOCS_SCREENSHOT_DIR, '05-original.png') });
    console.log('  ✓ Captured 05-original.png (1440x900)');
    ...
    await page.screenshot({ path: path.join(DOCS_SCREENSHOT_DIR, '06-current-chord.png') });
    console.log('  ✓ Captured 06-current-chord.png (1440x900)');
    ...
    console.log(`\n═════════════════════════════════════════════════════════════`);
    console.log(`🎉 All v0.3 Release Screenshots Saved to:`);
